...
$(document).ready(function(){
    /*
    * dynamically adds <select> html elements to the page based on the 
    * number of children at LSA entered by the user.
    */
    $("#proceed").click( function(){
        var numStudents = parseInt($("#number-at-lsa").val());
    ...
    /*
     * displays full tuition, savings, adjusted tuition, monthly cost, and weekly cost based on user inputs.
    ...
    $("#calculateButton").click( function () {
        ...
        // calculate individual savings and display results
        ...
        // display. deeply ugly but jquery was being finnicky
        $("#finalresults").html(`<th class="thCalc">Tuition Calculation Results</th>`);
        $("#finalresults").append(`<tr><td class="tdCalc">Full Tuition</td><td class="tdCalc">$` + numberWithCommas(originalTotal.toFixed(2)) + `</td></tr>`);
        $("#finalresults").append(`<tr><td class="tdCalc">Estimated Tuition Assistance</td><td class="tdCalc">$` + numberWithCommas(savingsTotal.toFixed(2)) + `</td></tr>`);
        $("#finalresults").append(`<tr><td class="tdCalc2">Your Estimated Tuition</td><td class="tdCalc2">$` + numberWithCommas(totalTuition.toFixed(2)) + `</td></tr>`);
        $("#finalresults").append(`<tr><td class="tdCalc">Estimated Monthly Payment<span class="descriptionCalc">Based on a 10-month payment plan.</span></td><td class="tdCalc">$` + numberWithCommas((totalTuition / 10).toFixed(2)) + `</td></tr>`);
        $("#finalresults").append(`<tr><td class="tdCalc">Estimated Weekly Payment<span class="descriptionCalc">Based on a 10-month payment plan, with 4 weeks per month.</span></td><td class="tdCalc">$` + numberWithCommas((totalTuition / 40).toFixed(2)) + `</td></tr>`);
    ...
    * Note: we're not using their final answer because Safari somehow still doesn't support lookbehind in 2021.
    */
